                ...
                <div className='p-6'>
                    ...
                    <Tabs defaultValue="personal">
                        <TabsList className="gap-6 w-full mb-2 text-grey-700 " >
                            ...
                            <TabsTrigger value="projects" className=" font-medium cursor-pointer">Current Projects</TabsTrigger>
                            <TabsTrigger value="system" className=" font-medium cursor-pointer">System Info</TabsTrigger>
